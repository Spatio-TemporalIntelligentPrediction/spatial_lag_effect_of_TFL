...
2. Extract the file (if you downloaded the `.zip` version).
3. Place the `2m_temperature_hourly.nc` file into the `data/` directory of this repository.
4. You are now ready to run the analysis scripts!
